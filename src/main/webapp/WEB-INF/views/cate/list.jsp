		...
		<div class="container px-4 px-lg-5 mt-5">
			<div
					...
					<div class="card h-100">
						...
						<div class="card-body p-4">
							<div class="text-center">
								<!-- Product name-->
								<a href="/restaurant/list.do">
									<h5 class="fw-bolder">전체 보기</h5>
								</a>
							</div>
						</div>
						<!-- Product actions-->
				...
				<div class="col mb-5">
					<div class="card h-100">
						<!-- 추 -->
						<a href="/restaurant/list_recommend.do?id=${sessionScope.id}"><img
							class="card-img-top" height="200px" src="/main/추천.jpg"
							alt="..." /></a>
						...
						<div class="card-body p-4">
							<div class="text-center">
								<!-- Product name-->
								<a href="/restaurant/list_by_cateno.do?cateno=${cateno}">
									<h5 class="fw-bolder">추천 음식점</h5>
								</a>
							</div>
						</div>
						<!-- Product actions-->
