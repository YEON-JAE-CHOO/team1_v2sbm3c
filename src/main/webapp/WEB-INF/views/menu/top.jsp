...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
            ...
            <c:choose>
                 <c:when test="${sessionScope.reco < 10}"> <%-- 로그인 한 경우 (관리자 - 회원목록/가게등록/가게목록) --%>
                  <!--  로그인한 관리자만 가능 ( 관리자 ID:qnaadmin / hong PW:1234) -->
                   <li class="nav-item"><a class="nav-link"   href="/members/list.do">회원목록</a></li>
        ...
        <c:choose>
            <c:when test="${sessionScope.id != null}">
                <a href="/shoppingcart/openshoppingcart.do?mid=${sessionScope.id }"  class="bi-cart-fill me-1"> Cart <span class="badge bg-dark text-white ms-1 rounded-pill">0</span>
                </a>
            </c:when>
        </c:choose>
...
>>>>>>> 9af7cfe78e1c4793b907fa076deae1be1025180d
