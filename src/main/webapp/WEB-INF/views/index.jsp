			...
			<div id="carouselExampleIndicators" class="carousel slide"
				...
				<div class="carousel-inner" style='height: 300px'>
					<div class="carousel-item active">
						<img src="/main/치킨1.jpg" class="d-block w-100" style='height: 300px' alt="...">
					</div>
					<div class="carousel-item">
						<img src="/main/족발보쌈.jpg" class="d-block w-100" style='height: 300px' alt="...">
					</div>
					<div class="carousel-item">
						<img src="/main/치킨.jpg" class="d-block w-100" style='height: 300px' alt="...">
					</div>
				</div>
