...
<jsp:include page="../menu/top.jsp" flush='false' />
  ...
  <FORM name='frm' id='frm' method='POST' action='./create.do' class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='pw' class="form-control" name='pw' id='pw' value='' required="required" style='width: 30%;' placeholder="패스워드">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='pw' class="form-control" name='pw2' id='pw2' value='' required="required" style='width: 30%;' placeholder="패스워드">
      </div>
    </div>   
    ...
    <div class="form-group">
      <label for="housecode" class="col-md-2 control-label" style='font-size: 0.9em;'>우편번호</label>    
      <div class="col-md-10">
