        ...
        <jsp:include page="../menu/top.jsp" flush='false' />
           ...
           <header class="py-4" style="background-color: #ef9578;">
                ...
                <div class="text-center text-white">
                        <h1 class="display-4 fw-bolder">회원 패스워드 변경</h1>
                        <p class="lead fw-normal text-white-50 mb-0">PW_UPDATE</p>
...
<script type="text/javascript">
  ...
  function send() {
    if ($('#new_pw').val() != $('#new_pw2').val()) {
      ...
      $('#btn_close').attr("data-focus", "new_pw");
...
<body>
  ...
  <DIV class='content_body'>
    ...
    <FORM name='frm' id='frm' method='POST' action='./pw_update.do' 
      ...
      <div class="form-group">
        ...
        <div class="col-md-7">
          <input type='pw' class="form-control" name='current_pw' 
                    id='current_pw' value='' required="required" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-7">
          <input type='pw' class="form-control" name='new_pw' 
                    id='new_pw' value='' required="required" 
                    style='width: 30%;' placeholder="패스워드">
        </div>
      </div>   
      ...
      <div class="form-group">
        ...
        <div class="col-md-7">
          <input type='pw' class="form-control" name='new_pw2' 
                    id='new_pw2' value='' required="required" 
                    style='width: 30%;' placeholder="패스워드">
        </div>
      </div>   
