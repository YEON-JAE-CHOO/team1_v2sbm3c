        ...
        <jsp:include page="../menu/top.jsp" flush='false' />
           ...
           <header class="py-4" style="background-color: #ef9578;">
                ...
                <div class="text-center text-white">
                        <h1 class="display-4 fw-bolder">회원 정보 조회 및 수정</h1>
                        <p class="lead fw-normal text-white-50 mb-0">Edit member information</p>
               </div>
              </div>
           </header>
      <!-- Section-->
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='text' class="form-control" name='housecode' id='housecode' 
                     value='${membersVO.housecode }' required="required" style='width: 30%;' placeholder="우편번호">
      ...
      function DaumPostcode() {
          ...
          new daum.Postcode({
              oncomplete: function(data) {
                  ...
                  document.getElementById('housecode').value = data.zonecode; //5자리 새우편번호 사용
