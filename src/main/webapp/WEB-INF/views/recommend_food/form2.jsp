...
<body>
	...
	<header class="py-4" style="background-color: #ef9578;">
		<div class="container px-4 px-lg-5 my-5"
			...
			<div class="text-center text-white">
				<h1 class="display-4 fw-bolder">2/5 단계입니다.</h1>
			</div>
		</div>
	</header>
	<br>
	<DIV class="container">
		...
		<form id='frm' name='frm' action='/recommend_food/form3.do' method='GET'>
			<input type='hidden' name='step1' value='${param.step1 }'> <br>
			<TABLE style='margin: 0px auto;'>
				...
				<TR>
					<TD class='td_radio'><input type='radio' name='step2'
