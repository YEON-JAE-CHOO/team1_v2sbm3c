...
public class NoticeProc implements NoticeProcInter {
    ...
    public int update_seqno_down(int noticeno) {
      ...
      @Override public int update_visible(NoticeVO noticeVO) { int cnt = 0; if
      (noticeVO.getVisible().toUpperCase().equals("Y")) {
      noticeVO.setVisible("N"); } else { noticeVO.setVisible("Y"); }
      cnt = this.noticeDAO.update_visible(noticeVO); return cnt; }
